...
-- ------------------------------------------------------------------------------------- --
## PENDIENTES
## Crear un una tabla de roles actualizados (Quíen lo hizo y la fecha) y disparador 
## cada vez que se actualiza un rol. Línea 379
## Crear una tabla de roles eliminados (Quíen lo hizo y la fecha). Línea 379
-- -------------------------------------------------------------------------------------
